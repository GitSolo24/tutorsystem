 ...
 <div class="container-fluid" style="max-width: 95%;">
  <div class="row">
    ...
    <div class="col-sm-9" style="background-color:#e3e3e3;margin-left:10px;">
      ...
      <a  href="uploadf.php">
            <i style="font-size: 30px;" class="glyphicon glyphicon-shopping-cart"></i>
            <div><a href="uploadf.php"> Upload Senior Courses</a></div>
            <div></div>
        </a>
      </div>
      ...
      <a  href="uploadm.php">
            <i style="font-size: 30px;" class="glyphicon glyphicon-shopping-cart"></i>
            <div><a href="uploadm.php">  Upload Sophomore Courses</a></div>
            <div></div>
        </a>
      </div><br>
      <div style="background: #c1c1c1; width: 150px;text-align: center;font-weight: bolder;text-decoration: none;border-radius: 10px;">
      <a  href="uploada.php">
            <i style="font-size: 30px;" class="glyphicon glyphicon-shopping-cart"></i>
            <div><a href="uploada.php">Upload Junior Courses</a></div>
            <div></div>
        </a>
      </div>
          </div>
