    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="alert alert-danger">
				Are you sure you want to delete this course <span style="color:#428bca;"><?php echo $row['name']; ?><img src="../women/girlsproduct/<?php echo $row['image'];?>" style="height: 50px;"></span>?
			</div>
