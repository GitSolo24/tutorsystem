...
<head>
  ...
  <title>Inter-School Tutoring System - CourseTaker</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#myPage">Inter-School Tutoring System - CourseTaker</a>
    </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="slide1.jpg" alt="New York" width="1200" height="700" style="min-height:577px;max-height:577px;">      
      </div>

      <div class="item">
        <img src="slide2.jpg" alt="Chicago" width="1200" height="700" style="min-height:577px;max-height:577px;">     
      </div>
    
      <div class="item">
        <img src="slide3.jpg" alt="Los Angeles" width="1200" height="700" style="min-height:577px;max-height:577px;">     
      </div>
...
<div id="shop" class="container text-center">
  <h2 style="color:#000;">CourseTaker</h2>
  <p><em></em></p>
  <p></p>
  <br>
  <div class="row">
    <div class="col-sm-4" style="float:right;right:-60px;">
      ...
      <p class="text-center"><strong class="btn btn-success" style="border-radius:5px; border-color:none;background:#000;color:#ffffff;">SENIOR <span style="background: red;border-radius: 5px;"> <?php echo $num_rows; ?> </span> </strong></p><br>
  ...
  ?>
    ...
    <div class="col-sm-4" style="float:right;right:-60px;">
      <p class="text-center"><strong class="btn btn-success" style="border-radius:5px;background:#000;color:#ffffff;">SOPOHOMORE <span style="background: red;border-radius: 5px; min-width: 100px;"><?php echo $num_rows; ?></span></strong></p><br>
      <a href="men/mens.php">
    ...
    <div class="col-sm-4" style="float:right;right:-60px;">
     ...
     $num_rows = mysqli_num_rows($result);
     ?>
      <p class="text-center"><strong class="btn btn-success" style="border-radius:5px;background:#000;color:#ffffff;">JUNIOR <span style="background: red;border-radius: 5px;"><?php echo $num_rows;?></span></strong></p><br>
...
<div id="tour" class="bg-1">
  <div class="container">
    ...
    <p class="text-center">Inter-School Tutoring System - CourseTaker
    is a platform that allows students to buy courses. This will help to find tutors from nearby locations. </p>
    <ul class="list-group">
      <li class="list-group-item">Get Discount <span class="label label-danger">Subscribe And Get 10% discount</span></li>  <br>
...
<div id="contact" class="container">
  ...
  <div class="row">
    <div class="col-md-4">
      <p>Contact us</p>
      <p><span class="glyphicon glyphicon-map-marker"></span>Inter-School Tutoring System - CourseTaker</p>
      <p><span class="glyphicon glyphicon-phone"></span>Phone: +1 832 778 1454</p>
      <p><span class="glyphicon glyphicon-envelope"></span>Email: contact@coursetaker.com</p>
    </div>
    <div class="col-md-8">
      <div class="row">
...
<footer class="text-center">
 ...
 © 2022 All Right Reserved Inter-School Tutoring System - CourseTaker
</p> 
</footer>
